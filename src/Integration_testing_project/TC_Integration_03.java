...
public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(1000);
		 ...
		 driver.findElement(By.xpath("//div[text()='S']")).click();
		 driver.findElement(By.xpath("//li[text()='My Profile']")).click();
		String updated_gender = driver.findElement(By.xpath("(//tbody/child::tr/child::td)[5]")).getText();
		 

		if (updated_gender.equalsIgnoreCase("female")) {
			System.out.println("Proper gender is displayed");
		}
		else {
			System.out.println("Proper gender is Not displayed");
		}
