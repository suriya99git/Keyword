...
public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(1000);
		WebElement first_name = driver.findElement(By.xpath("//input[@id='Last Name']"));
		Thread.sleep(1000);
		 JavascriptExecutor js = (JavascriptExecutor) driver;
		 Thread.sleep(1000);
		 js.executeScript("arguments[0].value='John';", first_name);
		 Thread.sleep(1000);
		 ...
		 driver.findElement(By.xpath("//div[text()='S']")).click();
		 driver.findElement(By.xpath("//li[text()='My Profile']")).click();
		boolean name = driver.findElement(By.xpath("(//tbody/child::tr/child::td)[2]")).isDisplayed();
		if (name) {
			System.out.println("Second Name properly displayed");
		}
		else {
			System.out.println("Second Name Not proprly displayed");
		}
